...
data = dict(
    ...
    train=dict(
        ...
        classes=('bigship', ),
        ann_file=
        '/home/wucx/dataset/tzb/input_path_obb/train_1024_mss/annfiles/',
        img_prefix=
        '/home/wucx/dataset/tzb/input_path_obb/train_1024_mss/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadOBBAnnotations',
    ...
    val=dict(
        ...
        task='Task1',
        classes=('bigship', ),
        ann_file='/home/wucx/dataset/tzb/input_path_obb/val_1024_mss/annfiles/',
        img_prefix='/home/wucx/dataset/tzb/input_path_obb/val_1024_mss/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipRotateAug',
...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        max_per_img=2000))
work_dir = 'work_dirs_tzb/faster_rcnn_orpn_r50_fpn_3x_dota10_mss_tzb_001/'
gpu_ids = range(0, 1)
